...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-effsize-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-effsize-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-effsize-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-effsize-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-effsize-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-effsize-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-effsize/badges/version.svg)](https://anaconda.org/conda-forge/r-effsize)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-effsize/badges/downloads.svg)](https://anaconda.org/conda-forge/r-effsize)
